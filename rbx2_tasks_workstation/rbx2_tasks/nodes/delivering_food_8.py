...
class MyMainClass():
    def __init__(self):
        ...
        with sm_table3:
            ...
            StateMachine.add('GOTO_KITCHEN', nav_states['kitchen'], transitions={'succeeded':'',
                                                                                 'aborted':'GOTO_CHECKPOINT_1a'})

            # if something wrong when we tried to go to the table

            StateMachine.add('GOTO_CHECKPOINT_2', nav_states['checkpoint2'], transitions={'succeeded':'GOTO_TABLE3_2',
            																	   		  'aborted':'GOTO_CHECKPOINT_1'} )

            StateMachine.add('GOTO_CHECKPOINT_1', nav_states['checkpoint1'], transitions={'succeeded':'GOTO_CHECKPOINT_2z',
            																	     	  'aborted':'GOTO_KITCHEN'} )

            StateMachine.add('GOTO_CHECKPOINT_2z', nav_states['checkpoint1'], transitions={'succeeded':'GOTO_TABLE3_2',
            																	     	  'aborted':'GOTO_KITCHEN'} )
            ...
            StateMachine.add('GOTO_CHECKPOINT_1a', nav_states['checkpoint1'], transitions={'succeeded':'GOTO_KITCHEN_2',
            																			   'aborted':'GOTO_CHECKPOINT_2a'})

            StateMachine.add('GOTO_CHECKPOINT_2a', nav_states['checkpoint2'], transitions={'succeeded':'GOTO_CHECKPOINT_1a',
            																			   'aborted':'CLEARING_NOISE_BACK_a'})

            StateMachine.add('CLEARING_NOISE_BACK_a', Rotate360(0.8, 2*pi), transitions={'full_rotate':'GOTO_CHECKPOINT_2a',
            																	 		 'not_full_rotate':'GOTO_CHECKPOINT_2a'})

            StateMachine.add('GOTO_KITCHEN_2', nav_states['kitchen'], transitions={'succeeded':'',
            																	   'aborted':'CLEARING_NOISE_BACK_b'})

            StateMachine.add('CLEARING_NOISE_BACK_b', Rotate360(0.8, 2*pi), transitions={'full_rotate':'GOTO_KITCHEN_3',
            																	 'not_full_rotate':'GOTO_KITCHEN'})

            StateMachine.add('GOTO_KITCHEN_3', nav_states['kitchen'], transitions={'succeeded':'',
            																	   'aborted':'GOTO_KITCHEN_2'})
        ...
        with sm_table4:
            ...
            StateMachine.add('GOTO_KITCHEN', nav_states['kitchen'], transitions={'succeeded':'',
                                                                                 'aborted':'GOTO_CHECKPOINT_1a',
                                                                                 'preempted':'GOTO_CHECKPOINT_1a'})

            # if something wrong when we tried to go to the table

            StateMachine.add('GOTO_CHECKPOINT_2', nav_states['checkpoint2'], transitions={'succeeded':'GOTO_TABLE4_2',
            																	   		  'aborted':'GOTO_CHECKPOINT_1'} )

            StateMachine.add('GOTO_CHECKPOINT_1', nav_states['checkpoint1'], transitions={'succeeded':'GOTO_CHECKPOINT_2',
            																	     	  'aborted':'GOTO_KITCHEN'} )

            StateMachine.add('GOTO_TABLE4_2', nav_states['table4'], transitions={'succeeded':'ROTATE_SEARCH',
            																	 'aborted':'CLEARING_NOISE_GO'})

            StateMachine.add('CLEARING_NOISE_GO', Rotate360(0.4, 2*pi), transitions={'full_rotate':'GOTO_TABLE4_3',
            																'not_full_rotate':'GOTO_KITCHEN'})
            ...
            StateMachine.add('CLEARING_NOISE_BACK_b', Rotate360(0.4, 2*pi), transitions={'full_rotate':'GOTO_KITCHEN_3',
            																	 'not_full_rotate':'GOTO_KITCHEN'})
        ...
        with sm_table6:
            ...
            StateMachine.add('GOTO_CHECKPOINT_2', nav_states['checkpoint2'], transitions={'succeeded':'GOTO_TABLE6_2',
            																	   		  'aborted':'GOTO_CHECKPOINT_1'} )
    ...
    def initialize_destination(self):
        ...
        euler_angles = (0, -pi/2, pi, 0, pi/2, -pi/2, -3*pi/4, 3*pi/4, pi/2)
