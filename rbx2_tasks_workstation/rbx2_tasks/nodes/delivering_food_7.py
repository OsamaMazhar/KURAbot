...
class MyMainClass():
    def __init__(self):
        ...
        with sm_rotate_search:
            Concurrence.add('ROTATE', Rotate360(0.4) )
        ...
        with sm_table3:
            ...
            StateMachine.add('CLEARING_NOISE_GO', Rotate360(0.8), transitions={'full_rotate':'GOTO_TABLE3_3',
            ...
            StateMachine.add('GOTO_KITCHEN_2', nav_states['kitchen'], transitions={'succeeded':'',
            																	   'aborted':'CLEARING_NOISE_BACK'})

            StateMachine.add('CLEARING_NOISE_BACK', Rotate360(0.8), transitions={'full_rotate':'GOTO_TABLE3_3',
            																	 'not_full_rotate':'GOTO_KITCHEN'})
        ...
        with sm_table5:
            StateMachine.add('GOTO_TABLE5', nav_states['table5'], transitions={'succeeded':'ROTATE_SEARCH','aborted':'GOTO_CHECKPOINT_2','preempted':'GOTO_CHECKPOINT_2'})
            StateMachine.add('ROTATE_SEARCH', sm_rotate_search, transitions={'find':'DO_STUFFS','not_find':'GOTO_KITCHEN'})
            StateMachine.add('DO_STUFFS', DoStuffs(5), transitions={'succeeded':'GOTO_KITCHEN','aborted':'GOTO_KITCHEN','preempted':'GOTO_KITCHEN'})
            StateMachine.add('GOTO_KITCHEN', nav_states['kitchen'], transitions={'succeeded':'','aborted':'','preempted':''})
